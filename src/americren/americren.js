...
import { StyleSheet, Text, View, ImageBackground, ScrollView, Image, Alert } from 'react-native';
import { Header, Icon, Avatar, Button, Input } from 'react-native-elements';
import firebase from "../../config/firebase"

export default class Americren extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      email: "",
          ...
          <ImageBackground source={require("../../assets/back.jpg")} style={{ height: '100%', width: '100%', }} resizeMethod="auto" resizeMode="stretch">
            <ScrollView>
              <View style={styles.container}>
                ...
                <View style={{
                  alignItems: "center", justifyContent: "center", flex: 1, left: "3%"
                }}>
