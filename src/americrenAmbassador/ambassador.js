...
export default class Ambassador extends React.Component  {
  ...
  static navigationOptions = {
    drawerLabel: 'AMERICREN AMBASSADOR',
          ...
          <ImageBackground source={require("../../assets/back.jpg")} style={{ height: '100%', width: '100%', }} resizeMethod="auto" resizeMode="stretch">
            <ScrollView>
              <View style={styles.container}>
                ...
                <View>
                  <Text style={{ color: "#fff", left: "3%",  fontSize: 20 , padding: 10 }}>Where America Shops Realtors</Text>
                </View>

                <View style={{display:"flex", flexDirection:"row", width:"100%"}}>

                <View  style={{width:"60%", height:"100%", left: "7%"}}>
